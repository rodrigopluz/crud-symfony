...
class ItemPedidoController extends Controller
{
    ...
    public function indexAction($pedido, Request $request)
    {
        if (isset($pedido)) {
            ...
            $pedidoObject = $pu->findBy(['numero' => $pedido]);
            ...
            return $this->render('pedido/carrinho.html.twig', [
                'pedido' => $pedidoObject
            ]);
        }
    ...
    public function novoClienteAction($pedido, Request $request)
    {
        if (isset($pedido)) {
            ...
            $pedidoObject = $puPedido->findBy(['numero' => $pedido]);
            ...
            return $this->render('pedido/add-item.html.twig', [
    ...
    public function inserirItemPedidoAction(Request $request)
    {
        if ($request->isMethod('GET')) {
            return new RedirectResponse($this->generateUrl('gerenciar_pedido', ['pedido' => $request->get('pedido')]));
        }
        ...
        if ($form->isValid()) {
            ...
            $puPedido = new PersistenceUnity('AppBundle:Pedido', $this);
            $pedido = $puPedido->findBy(['numero' => $request->get('pedido')]);
            ...
            return new RedirectResponse($this->generateUrl('gerenciar_pedido', ['pedido' => $pedido->getNumero()]));
        }
    ...
    {
        return $this->createForm(new ItemPedidoType(), $entity, [
