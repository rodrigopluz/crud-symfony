...
class PedidoController extends Controller
{
    ...
    public function novoPedidoAction(Request $request)
    {
        ...
        return $this->render('pedido/form.html.twig', [
    ...
    public function visualizarPedidoAction($pedido, Request $request)
    {
        if (isset($pedido)) {
            ...
            return $this->render('pedido/visualizar-pedido.html.twig', [
                'pedido' => $pedidoObject
            ]);
        }
    }
    ...
    {
        return $this->createForm(new PedidoType(), $entity, [
    ...
    private function createEditForm(Pedido $entity)
    {
        return $this->createForm(new PedidoType(),
            $entity,
            [
                'action' => $this->generateUrl('atualizar_pedido', ['id' => $entity->getId()]),
                'method' => 'POST'
            ]);
    }
}